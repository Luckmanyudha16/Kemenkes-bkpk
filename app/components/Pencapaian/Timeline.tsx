...
const data = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: "image", src: ["kajian.jpg", "kajian2.jpg"], judul:"<h2><b>Kajian Implementasi Kebijakan</b></h2>", description: "BKPK sudah melaksanakan 21 topik kajian Implementasi Kebijakan:<br> <ol> <li>1. Evaluasi implementasi integrasi pelayanan kesehatan primer</li> <li>2. Evaluasi implementasi integrasi peningkatan kualitas layanan antenatal dengan USG di Puskesmas</li> <li>3. Kajian implementasi program PMT berbahan pangan lokal pada anak balita</li> <li>4. Kajian implementasi kebijakan peningkatan kapasitas kader dalam pemantauan pertumbuhan balita</li>  <li>5. Riset implementasi pilot project pengembangan model pelayanan kesehatan jiwa masyarakat</li> <li>6. Kajian implementasi kebijakan penemuan kasus dan pengobatan tuberkulosis di Indonesia</li> <li>7. Kajian implementasi kebijakan teknologi Wolbachia</li> <li>8. Kajian implementasi RAN eliminasi kanker leher rahim</li> <li>9. Kajian implementasi kebijakan program jejaring rujukan kanker, kardiovaskuler, stroke, dan uronefrologi</li> <li>10. Riset implementasi kebijakan program Biomedical Genome-based Science Initiative for precision medicine (BGSi)</li> <li>11. Riset implementasi kebijakan kelas rawat inap standar (KRIS)</li> <li>12. Kajian evaluasi kebijakan program clinical trial vaksin TB</li> <li>13. Evaluasi implementasi KMK Nomor 1314 Tahun 2023 tentang substitusi obat dan alat kesehatan impor dengan obat dan alat kesehatan dalam negeri pada katalog sektoral kesehatan bagi industri kesehatan</li> <li>14. Riset implementasi kebijakan change source bahan baku obat</li> <li>15. Kajian implementasi kebijakan dana bantuan operasional kesehatan (BOK)</li> <li>16. Kajian implementasi SatuSehat</li> <li>17. Penyediaan USG di Puskesmas untuk ANC berkualitas</li> <li>18. Kajian implementasi program PMT berbahan pangan lokal</li> <li>19. Kajian implementasi penyediaan alat antropometri di Posyandu</li> <li>20.Prioritas change sources bahan baku obat dalam negeri</li> <li>21. Imunisasi HPV, PCV, dan Rotavirus</li> </ol>"},
