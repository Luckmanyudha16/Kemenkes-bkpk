    ...
    <div className={styles.timelineContainer}>
      ...
      {isPopupVisible && selectedIndex !== null && (
        <div
          ...
          <div className="mockup-phone max-w-md">
            <div className="camera max-w-md"></div>
            <div className="display max-w-md">
              <div className="artboard artboard-demo max-w-md">
                <button
