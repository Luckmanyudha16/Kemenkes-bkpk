...
const data = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: "image", src: "sibijak award.jpg", judul:"<h2><b>SiBijaKs Awards 2024</b></h2>", description: "BKPK menyelenggarakan Rekomendasi Kebijakan Kesehatan (SiBijaKs) Awards 2024, yaitu kompetisi penulisan rekomendasi kebijakan kesehatan dengan data Survei Kesehatan Indonesia (SKI) tahun 2023 sebagai sumber data utama."},
      ...
      { type: "image", src: "Pelatihan SIMPLEK.jpg", judul:"<h2><b>Sistem Informasi Monitoring Implementasi Kebijakan (SIMPLEK)</b></h2>", description: "Untuk kinerja internal yang lebih baik, BKPK mengembangkan aplikasi SIMPLEK atau Sistem Informasi Monitoring Implementasi Kebijakan"},
