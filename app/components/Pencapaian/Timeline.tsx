...
const data = [
  ...
  },
  {
    ...
    media: [
      { type: "image", src: "mengawal.jpeg", judul:"<h2><b>Mengawal Penyusunan Kebijakan (UU dan Turunannya)</b></h2>", description: "Mengawal Penyusunan Kebijakan (UU dan Turunannya).<br>BKPK telah mengawal penyusunan kebijakan kesehatan sampai menghasilkan Undang Undang Kesehatan Nomor 17 tahun 2023 dan Peraturan Pemerintah Nomor 28 tahun 2024." },
      ...
      { type: "image", src: ["status gizi.jpg", "status gizi 2.jpg", "survei kesehatan indo.png"], judul:"<h2><b>Survei Status Gizi Indonesia (SSGI) & Survei Kesehatan Indonesia (SKI)</b></h2>", description: "BKPK telah menjalankan Survei Status Gizi Indonesia (SSGI) setiap tahun sejak 2019. Survei Status Gizi Indonesia sejak 2019, melibatkan konsorsium lembaga survei untuk manajemen lapangan pada tahun 2024. Keterlibatan para akademisi sebagai tim pakar dan validator eksternal SSGI. Bersama BPS serta BRIN dalam tim SSGI mengawal metodologi dan analisis data. BKPK juga melaksanakan Survei Kesehatan Indonesia (SKI) pada 2023. Pada Juli 2024, telah dilakukan diseminasi terhadap hasil survei tersebut."},
      { type: "image", src: "sibijak award.jpg", judul:"<h2><b>SiBijaKs Awards 2024</b></h2>", description: "SiBijaKs Awards 2024<br>BKPK menyelenggarakan Rekomendasi Kebijakan Kesehatan (SiBijaKs) Awards 2024, yaitu kompetisi penulisan rekomendasi kebijakan kesehatan dengan data Survei Kesehatan Indonesia (SKI) tahun 2023 sebagai sumber data utama."},
      { type: "image", src: ["islamic dev.jpg", "uni emirate  arab.jpeg", "sun medical.jpg" ], judul:"<h2><b>Kerja Sama Internasional</b></h2>", description: "Kerja Sama Internasional<br>BKPK menjalin Kerjasama Internasiona antara lain dengan untuk layanan Kesehatan Ibu dan Anak di 6 Rumah Sakit Vertikal, United Arab Emirates untuk Pembangunan Rumah Sakit Kardiologi di Solo, Sun Medical Centre Korea Selatan, Joint Operation Kemenkes dan Institute for Health Metrics and Evaluation (IHME)."},
      { type: "image", src: "vaksin.jpg", judul:"<h2><b>Vaksin Merah Putih</b></h2>", description: "Vaksin Merah Putih<br>BKPK berkolaborasi dengan Universitas Airlangga melaksanakan uji klinis  vaksin Merah Putih dan vaksin booster Covid-19."},
      { type: "image", src: ["jkn.jpg", "assesment teknologi.jpg"], judul:"<h2><b>National Health Account dan Health Technology Assessment</b></h2>", description: "National Health Account dan Health Technology Assessment<br>Untuk penguatan jaminan kesehatan, BKPK National Health Account yang menghasilkan potret belanja kesehatan Indonesia, belanja farmasi dan belanja berdasarkan penyakit. BKPK juga sudah melakukan review Health Technology Assessment untuk mendapatkan inovasi teknologi di program JKN."},
      { type: "image", src: ["arsitektur_global.jpeg", "arsitektur_regional.jpg"], judul:"<h2><b>Arsitektur Kesehatan Global</b></h2>", description: "Arsitektur Kesehatan Global<br>BKPK berperan penting dalam membangun Arsitektur Kesehatan Global saat Presidensi G20 ,dan Keketuaan ASEAN Tahun 2023"},
      { type: "image", src: "peran.jpg", judul:"<h2><b>Peran dalam Organisasi Internasional</b></h2>", description: "Peran dalam Organisasi Internasional<br>Wakil dari Kementerian Kesehatan menduduki posisi board maupun co-chair dalam organisasi internasional seperti pandemic fund, CEPI, Global fund, dan GAVI."},
      { type: "image", src: "kolaborasi.jpg", judul:"<h2><b>Kolaborasi Global</b></h2>", description: "Kolaborasi Global<br>BKPK memanfaatkan jejaring kolaborasi global untuk melakukan leap frog di bidang bioteknologi, genomik dan layanan kedokteran presisi dan juga peningkatan sistem informasi kesehatan."},
      { type: "image", src: "Pelatihan SIMPLEK.jpg", judul:"<h2><b>Sistem Informasi Monitoring Implementasi Kebijakan (SIMPLEK)</b></h2>", description: "Sistem Informasi Monitoring Implementasi Kebijakan (SIMPLEK)<br>Untuk kinerja internal yang lebih baik, BKPK mengembangkan aplikasi SIMPLEK atau Sistem Informasi Monitoring Implementasi Kebijakan"},
      { type: "image", src: "Pelatihan Koding.jpg", judul:"<h2><b>Layanan Data untuk Publik</b></h2>", description: "Sistem Informasi Monitoring Implementasi Kebijakan (SIMPLEK)<br>Untuk kinerja internal yang lebih baik, BKPK mengembangkan aplikasi SIMPLEK atau Sistem Informasi Monitoring Implementasi Kebijakan"},
  ...
  },
  {
    ...
    media: [
      { type: "image", src: "SKI.png", judul:"<h2><b>SSGI 2022</b></h2>", description: "Survei Kesehatan Indonesia (SKI) 2023 merupakan survei yang mengintegrasikan Riset Kesehatan Dasar (Riskesdas) dan Survei Status Gizi Balita Indonesia (SSGI). SKI 2023 dikerjakan untuk menilai capaian hasil pembangunan kesehatan yang dilakukan pada kurun waktu lima tahun terakhir di Indonesia, dan juga untuk mengukur tren status gizi balita setiap tahun (2019-2024). Data yang dihasilkan dapat merepresentasikan status kesehatan tingkat Nasional sampai dengan tingkat Kabupaten/Kota. Ketersediaan data dan informasi terkait capaian hasil pembangunan kesehatan penting bagi Kementerian Kesehatan, Pemerintah Provinsi dan Kabupaten/Kota sebagai bahan penyusunan kebijakan, program dan kegiatan pembangunan yang lebih terarah dan tepat sasaran berbasis bukti termasuk pengembangan Rencana Pembangunan Kesehatan Jangka Menengah Nasional (RPJMN 2024-2029) oleh Kementerian PPN/Bappenas. Dalam upaya penyediaan data yang valid dan akurat tersebut, Badan Kebijakan Pembangunan Kesehatan (BKPK) bekerjasama dengan Badan Pusat Statistik (BPS) dalam penyusunan metode dan kerangka sampel SKI 2023, serta bersama dengan Lintas Program di Kementerian Kesehatan, World Health Organization (WHO) dan World Bank dalam pengembangan instrumen, pedoman hingga pelaporan survei." },
      { type: "image", src: "logo_ski.png", judul:"<h2><b>Data Survei SKI 2023</b></h2>", description: "Survei Kesehatan Indonesia (SKI) 2023 merupakan survei yang mengintegrasikan Riset Kesehatan Dasar (Riskesdas) dan Survei Status Gizi Balita Indonesia (SSGI). SKI 2023 dikerjakan untuk menilai capaian hasil pembangunan kesehatan yang dilakukan pada kurun waktu lima tahun terakhir di Indonesia, dan juga untuk mengukur tren status gizi balita setiap tahun (2019-2024). Data yang dihasilkan dapat merepresentasikan status kesehatan tingkat Nasional sampai dengan tingkat Kabupaten/Kota. Ketersediaan data dan informasi terkait capaian hasil pembangunan kesehatan penting bagi Kementerian Kesehatan, Pemerintah Provinsi dan Kabupaten/Kota sebagai bahan penyusunan kebijakan, program dan kegiatan pembangunan yang lebih terarah dan tepat sasaran berbasis bukti termasuk pengembangan Rencana Pembangunan Kesehatan Jangka Menengah Nasional (RPJMN 2024-2029) oleh Kementerian PPN/Bappenas. Dalam upaya penyediaan data yang valid dan akurat tersebut, Badan Kebijakan Pembangunan Kesehatan (BKPK) bekerjasama dengan Badan Pusat Statistik (BPS) dalam penyusunan metode dan kerangka sampel SKI 2023, serta bersama dengan Lintas Program di Kementerian Kesehatan, World Health Organization (WHO) dan World Bank dalam pengembangan instrumen, pedoman hingga pelaporan survei." },
  ...
  },
  {
    ...
    description:
      "",
    media: [
      { type: "image", src: ["ld1.jpg", "ld2.jpg", "ld3.jpg","ld4.jpg"], judul:"", description: "Badan Kebijakan Pembangunan Kesehatan mengelola data hasil survey skala nasional, dimulai dari Riset Kesehatan Dasar (Riskesdas), Studi Status Gizi Indonesia (SSGI), Riset Fasilitas Kesehatan (Rifaskes), dan survey nasional lainnya." },
