...
const data = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: "image", src: "kajian.jpg", judul:"<h2><b>Kajian Implementasi Kebijakan</b></h2>", description: "Kajian Implementasi Kebijakan<br>BKPK sudah melaksanakan 16 topik kajian Implementasi Kebijakan."},
      { type: "image", src: ["status gizi.jpg", "status gizi 2.jpg", "survei kesehatan indo.png"], judul:"<h2><b>Survei Status Gizi Indonesia (SSGI) & Survei Kesehatan Indonesia (SKI)</b></h2>", description: "Survei Status Gizi Indonesia (SSGI) & Survei Kesehatan Indonesia (SKI)<br>BKPK telah menjalankan Survei Status Gizi Indonesia (SSGI) setiap tahun sejak 2019. Survei Status Gizi Indonesia sejak 2019, melibatkan konsorsium lembaga survei untuk manajemen lapangan pada tahun 2024. Keterlibatan para akademisi sebagai tim pakar dan validator eksternal SSGI. Bersama BPS serta BRIN dalam tim SSGI mengawal metodologi dan analisis data. BKPK juga melaksanakan Survei Kesehatan Indonesia (SKI) pada 2023. Pada Juli 2024, telah dilakukan diseminasi terhadap hasil survei tersebut."},
  ...
  },
  {
    ...
    media: [
      ...
      { type: "video", src: "0047.MTS", judul:"<h2><b>Data Survei SKI 2023</b></h2>", description: "Survei Kesehatan Indonesia (SKI) 2023 merupakan survei yang mengintegrasikan Riset Kesehatan Dasar (Riskesdas) dan Survei Status Gizi Balita Indonesia (SSGI). SKI 2023 dikerjakan untuk menilai capaian hasil pembangunan kesehatan yang dilakukan pada kurun waktu lima tahun terakhir di Indonesia, dan juga untuk mengukur tren status gizi balita setiap tahun (2019-2024). Data yang dihasilkan dapat merepresentasikan status kesehatan tingkat Nasional sampai dengan tingkat Kabupaten/Kota. Ketersediaan data dan informasi terkait capaian hasil pembangunan kesehatan penting bagi Kementerian Kesehatan, Pemerintah Provinsi dan Kabupaten/Kota sebagai bahan penyusunan kebijakan, program dan kegiatan pembangunan yang lebih terarah dan tepat sasaran berbasis bukti termasuk pengembangan Rencana Pembangunan Kesehatan Jangka Menengah Nasional (RPJMN 2024-2029) oleh Kementerian PPN/Bappenas. Dalam upaya penyediaan data yang valid dan akurat tersebut, Badan Kebijakan Pembangunan Kesehatan (BKPK) bekerjasama dengan Badan Pusat Statistik (BPS) dalam penyusunan metode dan kerangka sampel SKI 2023, serta bersama dengan Lintas Program di Kementerian Kesehatan, World Health Organization (WHO) dan World Bank dalam pengembangan instrumen, pedoman hingga pelaporan survei." },
      { type: "video", src: "IndonesiaRaya.mp4", judul:"", description: "" },
    ],
  },
  {
    ...
    media: [
      { type: "video", src: "peta.mp4", judul:"", description: "Badan Kebijakan Pembangunan Kesehatan mengelola data hasil survey skala nasional, dimulai dari Riset Kesehatan Dasar (Riskesdas), Studi Status Gizi Indonesia (SSGI), Riset Fasilitas Kesehatan (Rifaskes), dan survey nasional lainnya."},
      ...
      <div className={styles.timelineContainer}>
        ...
        <div className={styles.timeline}>
          {data.map((entry, index) => {
            ...
            const x = Math.round((radius * Math.cos(angle) + 50) * 90) / 115;
            const y = Math.round((radius * Math.sin(angle) + 50) * 90) / 115;
