...
import "./TokohPerjuangan.css";
import Link from "next/link";

export default function Tokoh_Perjuangan() {
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid max-w-md grid-cols-1 mx-auto mt-12 lg:max-w-full lg:mt-16 lg:grid-cols-3 gap-x-16 gap-y-12">
            ...
            {[
              {
                title: "Imam Bonjol 1",
                description: "Description for Imam Bonjol 1",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 2",
                description: "Description for Imam Bonjol 2",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 3",
                description: "Description for Imam Bonjol 3",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 4",
                description: "Description for Imam Bonjol 4",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 5",
                description: "Description for Imam Bonjol 5",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 6",
                description: "Description for Imam Bonjol 6",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 7",
                description: "Description for Imam Bonjol 7",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 8",
                description: "Description for Imam Bonjol 8",
                imgSrc: "imam.jpg",
              },
              {
                title: "Imam Bonjol 9",
                description: "Description for Imam Bonjol 9",
                imgSrc: "imam.jpg",
              },
            ].map((card, index) => (
              <div
                ...
                key={index}
                onClick={() => handleCardClick(card.description, card.imgSrc)}>
          ...
          {isModalOpen && (
            <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
              <div className="bg-white p-4 rounded shadow-lg max-w-md mx-auto">
                ...
                />
                <h3 className="text-lg font-bold mt-2">{modalContent}</h3>{" "}
