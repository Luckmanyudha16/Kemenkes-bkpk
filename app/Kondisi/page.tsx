...
export default function Kondisi() {
  return (
    <div className="flex flex-col min-h-screen"> {/* Full height layout */}
      <div className="container mx-auto px-6 flex-grow"> {/* Allow container to grow */}
        {/* Logo Section */}
        <div className="flex justify-between items-center gap-6 py-6"> {/* Fixed justify and align classes */}
          <img
            src="garuda.png"
            alt="Logo Garuda"
